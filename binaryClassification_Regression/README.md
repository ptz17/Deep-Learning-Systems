# # Task 1: Binary classification (60%)
...
# Tips
# 1) Shuffle your datasets before you start training (DO NOT SHUFFLE DURING TRAINING)
# 2) loading data "from numpy import genfromtxt"
#                 "my_data = genfromtxt('dataset-1.csv', delimiter=',')"
# 3) When debugging, fix your random seed for generating random numpy array for the init weights
# Task 2: Regression for fix-point binary numbers (40%)
...
# Tips
# 1) Think about how to model (features and labels), and how to enumerate all the data points
# 2) X is your input feasure vector, the corresponding floating point value is the your label